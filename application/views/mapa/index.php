            ...
            <ul class="sidebar-nav" id="sidebar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link collapsed" data-toggle="tooltip" title="Galeria de Mapas Base"
                  data-sidebar-panel="asideNotification_gallery" href="#">
                    ...
                    <select id="ccpoblado" class="form-control form-line">
                      ...
                      <?php if (isset($centros_poblado)) { ?>
                        <?php foreach ($centros_poblado as $ccpp) { ?>
                          <option value="<?php echo $ccpp['codccpp']; ?>"><?php echo strtoupper($ccpp['centropoblado']); ?>
                          </option>
                        <?php }
                      } ?>
      ...
      <header class="main-header bg-card d-flex flex-row justify-content-between align-items-center px-lg">
        ...
        <div class="ul-header-topbar text-white">
          <div class="flex-grow-1">
            <a data-toggle="tooltip" class="puntero"  abrirlModalCapas title="Reporte Seguimiento de Barridos" role=”button”
        ...
        <div id="bottomPanel" style="display: none;">
          <div id="timeInfo">
            <div><span id="botoncerrar_day" style="display: none;"><i
                  class="fas fa-times-circle icon icon-sm hover-gray close-panel-dias left-icon-dias"></i></span></div>
  ...
  <div class="modal fade dragable_modal" id="modalCapas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body p-3">
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">Cartografía censal
              (INEI)</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block ">Estratos por niveles de
              ingresos (INEI)</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">Zonas de expansión urbana
              (MIDIS)</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">Servicios de Salud
              (MINSA)</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">Instituciones
              educativas(MINEDU)</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">SISFOH-PGH georreferenciado
              (MIDIS)</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">CENEPRED</button></div>
          <div class="row m-1"> <button type="button" class="btn btn-secondary btn-block">Empradronamiento masivo 2023
              (DU 029-2023)</button></div>
        </div>
      </div>
