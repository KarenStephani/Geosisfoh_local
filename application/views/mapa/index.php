...
-->
                        ...
                        <ul class="show-on-load" id="ul-menu">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item midis-tab">
                                    <a class="nav-link active bg-warning" id="filter-tab" data-toggle="tab"
                                        href="#filter" role="tab">
                                        <i class="fas fa-filter"></i>
                                    </a>
                                </li>
                                <li class="nav-item midis-tab">
                                    <a class="nav-link  bg-primary" id="layer-tab" data-toggle="tab" href="#layer"
                                        role="tab">
                                ...
                                <li class="nav-item midis-tab">
                                    <a class="nav-link bg-danger" id="download-tab" data-toggle="tab" href="#download"
                                        role="tab">
                            ...
                            <div class="tab-content p-16 scroll-midis">
                                ...
                                <div class="tab-pane fade show active" id="filter" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-line"
                                            value="<?= $user['ubigeos']['nom_dpto'] ?>" readonly>
                                        <input id="ccdep_" type="hidden" value="<?= $user['ubigeos']['coddpto'] ?>"
                                            name="code" readonly />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($user["es_municipal"] == true) { ?>
                                        <input class="form-control form-line"
                                            value="<?= $user['ubigeos']['nom_prov'] ?>" readonly>
                                        <input id="ccprov_" type="hidden" value="<?= $user['ubigeos']['codprov'] ?>"
                                            name="code" readonly />
                                        <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($user["es_municipal"] == true) { ?>
                                        <input class="form-control form-line"
                                            value="<?= $user['ubigeos']['nombre_dist'] ?>" readonly>
                                        <input type="hidden" id="ccdist_" value="<?= $user['ubigeos']['iddist'] ?>"
                                            name="code" readonly />
                                        <?php } else { ?>
                                ...
                                <div class="tab-pane fade" id="layer" role="tabpanel" aria-labelledby="layer-tab">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div id="opciones_datos_p65" class="opciones_datos_p65"
                                                style="display:none;">
                                                <span style="display:none" id="datos_load_p65"><button type="button"
                                                        id="cargar_datos_load" class="btn btn-secondary-sup btn-icon"><i
                                                            class="fas fa-spinner fa-pulse"></i></button></span>
                                                <span id="botonesHerram" style="display: none;">

                                                    <button type="button" id="polygons"
                                                        class="btn btn-secondary-sup btn-icon" data-toggle="tooltip"
                                                        data-placement="top" title="Polygono"><i
                                                            class="fas fa-crop"></i></button>
                                                    <button type="button" id="freehands"
                                                        class="btn btn-secondary-sup btn-icon" data-toggle="tooltip"
                                                        data-placement="top" title="Libre Dibujo"><i
                                                            class="fas fa-draw-polygon"></i></button>
                                                    <button type="button" id="circle"
                                                        class="btn btn-secondary-sup btn-icon" data-toggle="tooltip"
                                                        data-placement="top" title="Circulo"><i
                                        ...
                                        <li>
                                            ...
                                            <div style="display: none;" id="leyen_cuna_mas" class="cunamas">
                                                <img
                                                    src="<?= base_url() ?>media/new_front/img/avatars/markercuna.png" /><span>Locales
                                                    CIAI</span><br>
                                                <img
                                                    src="<?= base_url() ?>media/new_front/img/avatars/wht-circle.png" /><span>Locales
                                                    SA</span>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <form class="form-menu"> <br>
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="<?= base_url() ?>media/Mapas/<?= $user['ubigeos']['iddist'] ?>.zip"
                                                    download class="boton-descarga">Descargar Mapa</a>
        ...
        <div class="main-content-wrap">
            ...
            <header class="main-header bg-card d-flex flex-row justify-content-between align-items-center px-lg">
                <div>
                    <a href="<?= site_url('App/index') ?>"><img
                            src="<?= base_url() ?>media/new_front/assets/logo-xs.png" /></a>
                </div>
                <div class="ul-header-topbar-men midis-opcions">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <div class="search-input position-relative">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="position-absolute top-50 translate-middle-y search-icon" width="25"
                    ...
                    <a id="zoom_in" class="btn-dist text-white" data-tooltip="Zoom Más"><i
                            class="fa fa-search-plus"></i></a>
                    <a id="zoom_out" class="btn-dist text-white" data-tooltip="Zoom Menos"><i
                ...
                <div class="ul-header-topbar text-white">
                    <div class="flex-grow-1">
                        ...
                        <a data-toggle="tooltip" class="puntero" style="color:#F9FCA8" abrirlModalCapas
                            title="Condiciones de Uso" role=”button” onclick="abrirModalCondiciones()"> <i
                                class="fi fi-rs-octagon-exclamation fa-2x"></i></a>
                        &nbsp;&nbsp;

                        <a data-toggle="tooltip" class="puntero" abrirlModalCapas
                            title="Reporte Seguimiento de Barridos" role=”button”
                            onclick="abrirModalSeguimientoBarrido()"> <i class="fi fi-rs-map-marker fa-2x"></i></a>

                        &nbsp;&nbsp;
                        <a data-toggle="tooltip" class="puntero" abrirlModalCapas title="Informe Estadístico"
                            role=”button” onclick="abrirModalEstadistica()"> <i
                                class="fi fi-rs-chart-pie-alt fa-2x"></i> </a>
            ...
            ?>
                    ...
                    <div class="dropdown">
                        <div class="header-btn-group">
                            <button class="btn btn-opacity-default rounded-circle btn-icon" type="button"
                                data-toggle="dropdown">
                                <img class="avatar-xs rounded-circle"
                                    src="<?= base_url() ?>media/new_front/img/avatar.png" alt="" />
                            </button>
                            <div class="dropdown-menu" style="margin-left:-110px">
                                ...
                                <a class="dropdown-item" href="<?= site_url('AppLogin/logout') ?>"><i
                                        class="fas fa-lock"></i> &nbsp;
                                    Cerrar sesión</a>
                            </div>
                        </div>
            ...
            <div class="main-content-body" id="MapaDiv">
                    ...
                    <div id="Tabla" class="tabcontent">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center">
                                <input class="form-control form-control-sm cls-ocultar" id="dniJefe" name="dniJefe"
                                    type="text" maxlength="50" placeholder="Ingresar DNI" autocomplete="off">
                                ...
                                <a class="btn btn-primary btn-sm cls-ocultar" id="btnBuscarJefe" href="#"
                                    role="button"><i class="fa fa-search"></i><span id="btnText"></span></a>
                        ...
                        <div id="idcontainer" style="min-width: 30%; height: 375px; margin: 0" class="scroll-tab">
                            <table id="datatable_AGSisfoh" class="table dt-responsive nowrap w-100 styled-table"
                                role="grid" aria-describedby="dt-responsive_info">
                                <thead>
                                    <tr>
                                        <th> Item </th>
                                        <th> Ver </th>
                ...
                <div id="ReporteInfortabla_p65" style="display:none" data-dojo-type="dijit/TitlePane"
                    ...
                    <div id="Tabla" class="tabcontent">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center">
                                <input class="form-control form-control-sm cls-ocultar" id="dniP65" name="dniP65"
                                    type="text" maxlength="50" placeholder="Ingresar DNI" autocomplete="off">
                                <a class="btn btn-primary btn-sm cls-ocultar" id="btnBuscarP65" href="#"
                                    role="button"><i class="fa fa-search"></i><span id="btnText">Buscar</span></a>
                    ...
                    <div id="herramientas_estratos">
                        <ul class="li-clas-list">
                            <li class="inp-position">
                                ...
                                <div class="button-container-herramientas" id="herramientasselec"
                                    style="display: none;">
                                    <button type="button" id="btn_polygons" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Polygono"><i
                                            class="fas fa-crop"></i></button>
                                    <button type="button" id="btn_freehands" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Libre Dibujo"><i
                                            class="fas fa-draw-polygon"></i></button>
                                    <button type="button" id="btn_circle" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Circulo"><i
                                            class="fas fa-circle"></i></button>
                                    <button type="button" id="btn_clear" class="btn btn-secondary-sup btn-icon"
                                ...
                                <div class="button-container-herramientas" id="herramientas_selec"
                                    style="display: none;">
                                    <button type="button" id="btns_polygons" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Polygono"><i
                                            class="fas fa-crop"></i></button>
                                    <button type="button" id="btns_freehands" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Libre Dibujo"><i
                                            class="fas fa-draw-polygon"></i></button>
                                    <button type="button" id="btns_circle" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Circulo"><i
                                            class="fas fa-circle"></i></button>
                                    <button type="button" id="btns_clear" class="btn btn-secondary-sup btn-icon"
                                        data-toggle="tooltip" data-placement="top" title="Borrar"><i
                                            class="fas fa-trash"></i></button>
                ...
                <div class="sidebar-body" data-suppress-scroll-x="true">
                    ...
                    <div class="contenedor-reporty">
                        ...
                        <div class="dato-estadistico">
                            ...
                            <input type="hidden" name="bk_meta_total" id="id_bk_meta"
                                value="<?php echo $data_meta[0]['meta']; ?>">
                        </div>
                    </div>
                    ...
                    <ul class="li-clas-list">
                        <li class="inp-position">
                            ...
                            <div class="button-container-herramientas">
                                <button type="button" id="ag_polygons" class="btn btn-secondary-sup btn-icon"
                                    data-toggle="tooltip" data-placement="top" title="Polygono"><i
                                        class="fas fa-crop"></i></button>
                                <button type="button" id="ag_freehands" class="btn btn-secondary-sup btn-icon"
                                    data-toggle="tooltip" data-placement="top" title="Libre Dibujo"><i
                                        class="fas fa-draw-polygon"></i></button>
                                <button type="button" id="ag_circle" class="btn btn-secondary-sup btn-icon"
                                    data-toggle="tooltip" data-placement="top" title="Circulo"><i
                                        class="fas fa-circle"></i></button>
                                <button type="button" id="ag_clear" class="btn btn-secondary-sup btn-icon"
                                    data-toggle="tooltip" data-placement="top" title="Borrar"><i
                                        class="fas fa-trash"></i></button>
                                <button type="button" id="ag_dias" class="btn btn-secondary-sup btn-icon"
                                    data-toggle="tooltip" data-placement="top" title="dias"><i
            ...
            <div class="modal-content">
                <div class="modal-header card-header btn-toolbar p-0 pl-1 dragable_touch">
                    ...
                    <div class="btn-group-m ml-auto" role="group" aria-label="Second group">
                        <button type="button" class="close close_btn" data-dismiss="modal" onclick="cerrarModal()"
                            aria-label="Close" data-backdrop="static" data-keyboard="false"><i
                ...
                <div class="modal-body p-3">
                    <div class="form-group">
                        ...
                        <input id="ccdep" type="hidden" value="<?= $user['ubigeos']['coddpto'] ?>" name="code"
                            readonly />
                    ...
                    <div class="form-group">
                        ...
                        <input id="ccprov" type="hidden" value="<?= $user['ubigeos']['codprov'] ?>" name="code"
                            readonly />
                        <?php } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="ccdist" value="<?= $user['ubigeos']['iddist'] ?>" name="code"
                            readonly />
                        <?php } else { ?>
    ...
    <div class="modal fade dragable_modal" id="modalMedicion" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel2">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header card-header btn-toolbar p-0 pl-1 dragable_touch">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    <div class="form-group">
                        ...
                        <input class="form-control form-line" value="<?= $user['ubigeos']['nom_dpto'] ?>" readonly>
                        <input id="ccdep_d" type="hidden" value="<?= $user['ubigeos']['coddpto'] ?>" name="code"
                            readonly />
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($user["es_municipal"] == true) { ?>
                        <input class="form-control form-line" value="<?= $user['ubigeos']['nom_prov'] ?>" readonly>
                        <input id="ccprov_d" type="hidden" value="<?= $user['ubigeos']['codprov'] ?>" name="code"
                            readonly />
                        <?php } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($user["es_municipal"] == true) { ?>
                        <input class="form-control form-line" value="<?= $user['ubigeos']['nombre_dist'] ?>" readonly>
                        <input type="hidden" id="ccdist_d" value="<?= $user['ubigeos']['iddist'] ?>" name="code"
                            readonly />
                        <?php } else { ?>
    ...
    <div class="modal fade dragable_modal" id="modalImprimir" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel2">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header card-header btn-toolbar p-0 pl-1 dragable_touch">
                ...
                <div class="modal-body p-3">
                    <div class="form-group">
                        ...
                        <input class="form-control form-line" value="<?= $user['ubigeos']['nom_dpto'] ?>" readonly>
                        <input id="ccdep_i" type="hidden" value="<?= $user['ubigeos']['coddpto'] ?>" name="code"
                            readonly />
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($user["es_municipal"] == true) { ?>
                        <input class="form-control form-line" value="<?= $user['ubigeos']['nom_prov'] ?>" readonly>
                        <input id="ccprov_i" type="hidden" value="<?= $user['ubigeos']['codprov'] ?>" name="code"
                            readonly />
                        <?php } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($user["es_municipal"] == true) { ?>
                        <input class="form-control form-line" value="<?= $user['ubigeos']['nombre_dist'] ?>" readonly>
                        <input type="hidden" id="ccdist_i" value="<?= $user['ubigeos']['iddist'] ?>" name="code"
                            readonly />
                        <?php } else { ?>
