                            ...
                            <div class="tab-content p-16 scroll-midis">
                                ...
                                <div class="tab-pane fade show active" id="filter" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="ccdep" type="hidden" value="<?= $user['ubigeos']['coddpto'] ?>"
                                            name="code" readonly />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="ccprov" type="hidden" value="<?= $user['ubigeos']['codprov'] ?>"
                                            name="code" readonly />
                                        <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="ccdist" value="<?= $user['ubigeos']['iddist'] ?>"
                                            name="code" readonly />
                                        <?php } else { ?>
...
<div class="modal fade dragable_modal" id="modalFiltros" tabindex="-1" role="dialog" style="postion:absolute;" aria-labelledby="myModalLabel2">
                ...
                <div class="modal-body p-3">
                    ...
                    <div class="form-group">
                        ...
                        <select id="ccpoblado" class="form-control form-line">
                            ...
                            <?php foreach ($centros_poblado as $ccpp) { ?>
                            <option value="<?php echo $ccpp['codccpp']; ?>">
                                <?php echo strtoupper($ccpp['centropoblado']); ?></option>
                            <?php }
              } ?>
